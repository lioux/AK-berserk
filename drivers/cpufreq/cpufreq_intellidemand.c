...
#define DEFAULT_FREQ_BOOST_TIME			(1200000)
#define DEF_SAMPLING_RATE			(50000)
#define BOOSTED_SAMPLING_RATE			(15000)
#define DBS_INPUT_EVENT_MIN_FREQ		(920000)

#ifdef CONFIG_CPUFREQ_ID_PERFLOCK
#define DBS_PERFLOCK_MIN_FREQ			(700000)
#endif
...
#define ACTIVE_MAX_FREQ		CONFIG_INTELLI_MAX_ACTIVE_FREQ		// 1200GHZ
#define INACTIVE_MAX_FREQ	CONFIG_INTELLI_MAX_INACTIVE_FREQ	// 920GHZ
